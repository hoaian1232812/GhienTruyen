...
public class FullFragment extends Fragment {
    ...
    public void setRecyclerView(View root) {
        ...
        Call<List<Story>> call = ApiClient.getApiService().getStoriesCompletedByTopicOnPage(idTopic, limit, page);
    ...
    private void prepareData(int idTopic, int page, int count) {
        ...
        Call<List<Story>> call = ApiClient.getApiService().getStoriesCompletedByTopicOnPage(idTopic, count, page);
