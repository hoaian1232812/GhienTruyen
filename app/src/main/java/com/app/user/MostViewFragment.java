...
public class MostViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_most_view, container, false);
        pb_loading = root.findViewById(R.id.pb_loading_most);
    ...
    public void setRecyclerView(View root) {
        ...
        recyclerView = root.findViewById(R.id.recyle_story_topic_most);
        recyclerView.setLayoutManager(linearLayoutManager);
        int idTopic = getArguments().getInt("idTopic");
        Call<List<Story>> call = ApiClient.getApiService().getStoriesMostViewedByTopicOnPage(idTopic, limit, page);
    ...
    private void prepareData(int idTopic, int page, int count) {
        ...
        Call<List<Story>> call = ApiClient.getApiService().getStoriesMostViewedByTopicOnPage(idTopic, count, page);
        ...
        call.enqueue(new Callback<List<Story>>() {
            ...
            public void onResponse(Call<List<Story>> call, Response<List<Story>> response) {
                if (response.isSuccessful()) {
                    ...
                    Log.e("Lỗi", storyTopicAdapter.getItemCount() + "");
                    isLoading = false;
